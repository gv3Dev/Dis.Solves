...
<br><br>
<h3>Payment Info:</h3>
A purchase key will be given to the user upon purchase of the script. The price is different from person to person beacuse it's based on how many classes the person is ordering an EdgyBot for. Payment can only be sent via <b>Cashapp, Venmo, and Apple Pay/Apple Cash</b> for <b>security</b> reasons on both the users's end & mine. 🔑
<br><br>
<h3>Disclaimer:</h3>
