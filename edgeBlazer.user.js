// ==UserScript==
// @name            EdgyBot_blazer - Speed Controls 
// @updateURL       https://gitee.com/HGJing/everthing-hook/raw/master/src/plugins/timeHooker.js
// @version         1.0.62
// @description     This script will be used to speed up & or slow down the bot while it does the user's work. This will either be used to finish work faster & or avoid teacher suspicion and detection of script use.
// @include         *
// @require         https://greasyfork.org/scripts/372672-everything-hook/code/Everything-Hook.js?version=881251
// @author          [Cangshi] - Edited by EdgePlus+ for auto installation and use by edgyBot on edgenuity.
...
/*
This is another script that will also install alongside edgyBot upon installation. This script will be used to speed up & or slow down the bot 
while it does the user's work. This will either be used to finish work faster & or avoid teacher suspicion and detection of script use.
*/

// THIS SCRIPT IS AN EDITED VERSION OF TIMERHOOKER, ALL THANKS AND PRAISE GO TO THE CREATOR OF THAT WONDERFUL SCRIPT. 
// THE SCRIPT WILL BE AUTO INSTALLED ALONGSIDE OUR SCRIPT FOR THE USER'S EASE OF INSTALLATION!

// USE OF EDITED VERSION OF TIMERHOOKER FOR VERSIONS 1.9.8.5 & UP STARTS BELOW 
//  VVVVVV //
